const getProducts = async () => {
  try {
    const results = await fetch("./data/product.php");
    ...
    product => ` 
                  <div class="product category__products">
                    ...
                    <div class="product__footer">
                      ...
                      <a href="cart.php?add=${product.id}"><button type="submit" class="product__btn">Add To Cart</button></a>
                    </div>
                  <ul>
                      <li>
                        <a data-tip="Quick View" data-place="left" href="product.php?p=${product.id}">
                          <svg>
